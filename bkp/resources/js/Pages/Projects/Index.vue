    ...
    <BreezeAuthenticatedLayout>
        ...
        <div class="relative overflow-x-auto shadow-md bg-white sm:rounded-lg">
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600" v-for="(project,index) in filteredProjects" :key="project.id">
                        <td class="w-4 p-4">
                            <div class="flex items-center">
                            ...
                            <div class="flex items-center space-x-4">
                                <div class="flex-shrink-0">
                                    <span class="p-2 w-8 h-8 rounded-full bg-indigo-200 text-indigo-800">
                                        {{ avtarText(project.client.name) }}
                                    </span>
                                </div>
                                <div class="flex-1 min-w-0">
                                    <h6 class=" text-gray-900">{{ project.client.name }}</h6>
                        ...
                        <td class="px-6 py-4">
                            <button class="bg-green-100 text-green-800 text-xs font-semibold mr-2 px-3 py-1 rounded dark:bg-green-200 border dark:text-green-900 border-green-300" v-if="project.status == 1">Active</button>
